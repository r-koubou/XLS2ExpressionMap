...
COLUMN_NAME                 = "Name"
COLUMN_COLOR                = "Color"
COLUMN_ARTICULATION         = "Articulation"
COLUMN_ARTICULATION_TYPE    = "Articulation Type"
COLUMN_GROUP                = "Group"
COLUMN_PROGRAM_NUM          = "Program Change"
COLUMN_MIDI_NOTE            = "MIDI Note"
...
# Selectable Note No list (Order is same as Excel cell)
NOTENUMBER = [
    "C-2 (0)",
    "C#-2 (1)",
    "D-2 (2)",
...
# Selectable Articulation Type list (Order is same as Excel cell)
ARTICULATION_TYPE = [
    "Attribute",
    "Direction",
]
